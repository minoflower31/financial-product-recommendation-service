...
public class MemberController {
    ...
    public ResponseWrapper<GetMemberResponse> getMember() {
        return new ResponseWrapper<>(memberService.getMember(SecurityUtil.getCurrentMemberId())).ok();
    }
    ...
    public ResponseWrapper<Void> updatePasswordAdditionalInfo(@RequestBody UpdateMemberRequest request) {
        memberService.updatePassword(SecurityUtil.getCurrentMemberId(), request);
